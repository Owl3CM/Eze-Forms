...
const WebScanner = async (onResult) => {
  ...
  const container = Div(
    {
      style:
        'position:fixed;inset:0;z-index:999999999;background-color:rgb(22, 22, 22)'
    },
    [
      Video({
        style:
          'width: 100%; height: 100%; object-fit: cover; border-radius: 10px; border-radius:20px; '
      }),
